...
/**
 * Message Supervisor -> UI: ID of the removed node and with what message it was removed
 */
...
public class RemotionUpdateMsg {
    ...
    public RemotionUpdateMsg(@JsonProperty("direction") String direction,
        ...
        if (messageType != null && !SupervisorToUiMessageType.remotion_update.toString().equals(messageType)) {
